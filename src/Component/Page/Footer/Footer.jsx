...
const Footer = () => {
    return (
      ...
      <aside>
        <img className="w-20" src="https://i.ibb.co/2YNVVsP/edu-logo.jpg" alt="" />
    ...
    <p className="text-2xl"><span className="font-semibold text-red-400">EDUCATION CARE</span> Industries Ltd.<br/>Online Course Since 1990</p>
  </aside> 
